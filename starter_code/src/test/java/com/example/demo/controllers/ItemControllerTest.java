...
public class ItemControllerTest {
    ...
    @Test
    public void get_item_by_id_error_path() {
        ResponseEntity<Item> response = itemController.getItemById((long)0);
    ...
    @Test
    public void get_items_by_name_error_path() {
        ResponseEntity<List<Item>> response = itemController.getItemsByName("Flower Pot");
        assertEquals(404, response.getStatusCodeValue());
    }
